    ...
    %{
      class: %{
        body: [
          ...
          method: %{args: [], body: [return: {:ref, ["this", "id"]}], name: "getId", visibility: :public, type: ["int"]},
          method: %{args: [], body: [return: {:ref, ["this", "name"]}], name: "getName", visibility: :public, type: ["String"]},
          method: %{args: [], body: [return: {:chain, {:call, {["this", "foos", "stream"], []}}}], name: "getFooFoos", visibility: :public, type: {:generic, ["List"], [["String"]]}},
          method: %{
